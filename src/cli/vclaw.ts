...
import { CINEMATIC_15S_PRESET, buildShotPlan, composeBilingual, composePerShotFormat, composeSeedanceParagraph, generateMultiShotPromptText, listMultiShotPresets, parseMultiShotPrompt, presetNameForProvider, resolvePreset, type Lang, type MultiShotPreset } from '../video/multi-shot-prompt.js';
...
async function handleVideoMultiShot(args: string[]): Promise<void> {
  ...
  if (formatFlag !== 'default') {
    ...
    const rendered = formatFlag === 'seedance-paragraph'
