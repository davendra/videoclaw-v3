...
| `preview.html` | final viewer | Polished final showcase with click-to-fullscreen lightbox on every production image, a soundtrack `<audio controls preload="none">` player (rendered only when a soundtrack is discovered), and asset downloads. |
